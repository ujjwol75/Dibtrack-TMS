...
import { ArrowLeftIcon, BellIcon, BriefcaseIcon, CursorClickIcon, DocumentDownloadIcon, EmojiHappyIcon, XIcon } from '@heroicons/react/solid'
        ...
        <Dialog as="div" className="relative z-10" onClose={()=>{}}>
          ...
          >
            <div className="fixed inset-0 bg-black bg-opacity-25" >
              {/* <div className='absolute right-[10rem] top-6'>
              <XIcon className='w-10 h-10 inline-block '/>
              </div> */}
            </div>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className=' '>
              ...
              <div className='inline-block mr-[12rem]'>
                <CursorClickIcon className='w-5 h-5 text-blue-400 inline-block mr-3'/> <span className='text-white text-2xl'>Ramainder</span></div>
                <XIcon className='w-10 h-10 inline-block text-gray-400 cursor-pointer hover:text-white hover:transition duration-500 ease-in-out hover:rotate-90 ' onClick={closeModal}/>
              </div>
            </div>
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="m-2">
                    <input type="text" placeholder='Remainder Name or type "/" for comment' className='w-full p-2 outline-none text-xl bg-transparent text-gray-400 placeholder:text-xl' />
                  </div>
                  <hr />
                  ...
                  <div className='flex justify-between'>
                    ...
                    <div className="mt-4">
                      ...
                      {/* <EmojiHappyIcon className='w-6 h-6 inline-block text-gray-400 ml-1' /> */}
