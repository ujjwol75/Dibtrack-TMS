...
const Ltodo = (props: Props) => {
    ...
    return (
        <>
            <div className='flex w-[93.333333%] mx-auto h-8 justify-between p-3 shadow-sm mt-1 bg-white  items-center ' onClick={()=>{setOpenCardModal(true)}}>
                ...
                <div className='flex  w-[16rem] space-x-12 ml-8 '>
