    ...
    <>
      <div className='flex w-[93.333333%] mx-auto h-8 justify-between p-3 shadow-sm mt-1 bg-white  items-center '>
        <div className='flex space-x-2'>
          ...
          <input
            className='text-sm text-gray-400 font-light mx-2 w-[52rem] outline-none' value={userInput}
            onChange={(e) => {
        ...
        <div className='flex  w-[16rem] space-x-1  '>
          <IdentificationIcon
            className='ml-[7rem] h-6 w-6 text-sm text-gray-400 font-light  cursor-pointer hover:text-blue-400'/>
