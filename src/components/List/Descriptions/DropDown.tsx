    ...
    return (
        <div >
            <Popover className="relative">
                <Popover.Button className='px-2 ml-2 text-sm border border-blue-400 rounded-sm hover:bg-blue-400 '>{props.element}</Popover.Button>
                ...
                <Popover.Panel className="absolute z-11 w-[12rem] bg-white top-9 shadow-lg ">
                    ...
                    <p className='cursor-pointer text-sm px-2'><CheckIcon className='h-5 w-5 inline-block mr-1'/>Google Pulse</p>
                    <p className='cursor-pointer text-sm px-2'> <CheckIcon className='h-5 w-5 inline-block mr-1'/>New Google Doc</p>
                    </div>
