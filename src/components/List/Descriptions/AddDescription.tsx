import { ClockIcon, CalendarIcon, FlagIcon, EmojiHappyIcon, PrinterIcon, ViewGridIcon, ViewListIcon, CloudUploadIcon } from '@heroicons/react/solid'
...
<DescriptionModal isOpen={sidepop} setIsOpen={setSidepop} title={''} screenSize={true} >
