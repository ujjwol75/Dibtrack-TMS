import { ClockIcon, CalendarIcon, FlagIcon, ChatIcon, EmojiHappyIcon, PrinterIcon,DatabaseIcon, ViewGridIcon, ViewListIcon, CloudUploadIcon } from '@heroicons/react/solid'
            ...
            <CommentModal isOpen={sidepop} setIsOpen={setSidepop} title={''} screenSize={true} >
                <div className='flex '>
                    <div className='p-4 w-1/2'>
                        ...
                        <div >
                            <textarea name="" id="" className='w-full mt-4 h-[8.75rem] active:h-[10.75] hover:border-[1px] hover:border-gray-400 text-gray-400 outline-none p-1' />
                        ...
                        <div className='text-center mt-6'>
                            ...
                            <p className='text-gray-400'><CloudUploadIcon className='h-7 w-7 inline-block hover: text-blue-400' />Drop files here to attach or <span className='text-blue-400 underline mt-2'>browse</span> </p>
                        </div>


                    </div>

                    <div className='p-4 pb-[4rem] w-1/2 h-screen flex items-end border-l-2 border-gray-200' onClick={()=>{setUp(false)}}>
                        {/* <div>
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolore aspernatur illum neque, nostrum odio id ex, recusandae ea provident iste minus, consequatur doloribus rerum tempore adipisci fuga delectus eius ullam.
                        </div> */}
                        ...
                        {/* <CommentBox/> */}
                        {
                            ...
                            <div className='flex space-x-4'>
                                ...
                                {/* <DatabaseIcon className='w-8 h-8 text-gray-400 hover:text-blue-400'/> */}
