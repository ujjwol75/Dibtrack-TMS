            ...
            <div className='w-full shadow-2xl h-auto m-auto  p-2 my-4 rounded-md'>
                ...
                <div className='flex justify-between'>
                    <div className='flex '>
                        ...
                        <div className='flex'>
                            <div><p className='text-sm text-gray-400 font-light mx-2 cursor-pointer' onClick={() => { setTopEdit(!topEdit) }}>+NEW TASK</p></div>

                            <div><p className='text-sm text-gray-400 font-light mx-2' onClick={() => { setSidepop(true) }}>ADD Descriptions</p></div>
                            <div><p className='text-sm text-gray-400 font-light mx-2' onClick={() => { setComment(true) } }>ADD COMMENT</p></div>
                ...
                <p className='text-sm text-gray-400 font-light mx-2 mt-2 cursor-pointer' onClick={() => { setAdd(!add) }}>+New task</p>
