...
const LBox = (props: Props) => {
  ...
  return (
    <>
      <div className="w-[87rem] shadow-2xl h-auto m-auto  p-2 my-4 rounded-md">
        <div className="flex justify-between">
          <div className="flex ">
            ...
            <div className="flex">
              <div>
                <p
                  className="text-sm text-gray-400 font-light mx-2 cursor-pointer"
                  onClick={() => {
                    setTopEdit(!topEdit);
                  }}
                >
              ...
              <div>
                <p className="text-sm text-gray-400 font-light mx-2">
                  ADD DISCRIPTION
                </p>
              </div>
              <div>
          ...
          <div>
            <div className="flex">
              {" "}
              <CheckIcon className="w-5 h-5 text-sm text-gray-400 font-light mx-2" />{" "}
              <p className="text-sm text-gray-400 font-light mx-2">
                ADD COMMENT
              </p>{" "}
            </div>
                  ...
                  <div className="flex-col">
                    <div className="flex space-x-1">
                      ...
                      <div className="flex">
                        ...
                        <ArrowCircleUpIcon className="w-4 h-4 text-blue-400" />
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <p
          className="text-sm text-gray-400 font-light mx-2 mt-2 cursor-pointer"
          onClick={() => {
            setAdd(!add);
          }}
        >
