            ...
            {({ open }) => (
              <>
                ...
                <div className="flex flex-row justify-center w-[95%] mx-auto bg-bgsearchbar py-2 rounded-sm hover:bg-gray-300 text-xs">
                  ...
                  <p className="w-ull text-xs hover:bg-bgsearchbar mt-2  p-2">All</p>
                  <p className="w-ull text-xs hover:bg-bgsearchbar mt-2 p-2">Assigned to me</p>
                  <p className="w-ull text-xs hover:bg-bgsearchbar mt-2 p-2">shared</p>
                  <p className="w-ull text-xs hover:bg-bgsearchbar mt-2 p-2">private</p>
                </Disclosure.Panel>
              </>
            )}
          </Disclosure>
